...
extension Defaults.Keys {
  ...
  static let enableRedaction = Key<Bool>("enableRedaction", default: false)
  static let redactionFilters = Key<[RedactionFilter]>("redactionFilters", default: RedactionFilter.defaultFiltersWithSystem())
}
